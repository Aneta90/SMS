...
public class AdvancedCompressor implements Compressor {
   ...
   private static final String CODEBOOK[] = {
    ...
    @Override
    public String compress(String userMessage){

        confirmOnlyAscii(userMessage);

        StringBuilder verb = new StringBuilder();
        ByteArrayOutputStream output = new ByteArrayOutputStream();

        CharBuffer charBuffer = CharBuffer.wrap(userMessage);
        int inlen;
        ...
        return Arrays.toString(output.toByteArray());
    }
    ...
    private void outputVerb(ByteArrayOutputStream baos, String str) {
        if (str.length() == 1) {
            ...
            try {
                ...
                System.out.println("Error outputting verbatim data");
            }
        }
    }
